  ...
  {/*        <Image
        ...
        >
          ...
          <p className="max-w-lg leading-relaxed text-secondary">
            ...
            design-oriented approach. In addition to coding, I write a lot,
            where I focus on tech, life and happiness.
          </p>
        </div>
      </div>
      <div
      ...
      >
        ...
        <Card className="relative col-span-2 row-span-1" disableHalo noPadding>
          ...
          <div className="absolute bottom-4 left-4 flex items-center rounded-lg bg-neutral-100/75 px-4 py-1.5 backdrop-blur dark:bg-neutral-900/75 md:bottom-6 md:left-6">
            <p className="text-sm font-medium text-primary">Nancy, France</p>
          </div>
        </Card>
      </div>
      <div
      ...
      >
        <div className="space-y-4">
          ...
          <p className="max-w-lg leading-relaxed text-secondary">
            I occasionally write about programming, habits, and more. Check me
            out and subscribe to stay up to date.
          </p>
        </div>
